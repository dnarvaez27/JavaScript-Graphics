...
Progress.Round = function () {
    ...
    this.round_progress = {
        data: {
            ...
            append: function () {
                $( function () {
                    self.round_progress.data.round_progress_ids.forEach( function ( idContainer ) {
                        let container = document.getElementById( idContainer );
                        if ( container ) {
                            ...
                            if ( rProgress ) {
                                rProgress.setClickListener( function () {
                                    self.round_progress.data.round_progress_listener( JSON.parse( container.getAttribute( 'data' ) ) );
                                } );
                            }
                        }
                    } );
        ...
        init: function ( parent ) {
            $( function () {
                self.round_progress.data.round_progress_ids = [];
                if ( parent ) {
