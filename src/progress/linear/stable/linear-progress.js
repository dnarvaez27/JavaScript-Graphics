...
let linear_progress = {
    data: {
        ...
        append: function () {
            $( function () {
                linear_progress.data.linear_progress_ids.forEach( function ( idContainer ) {
                    let container = document.getElementById( idContainer );
                    if ( container ) {
    ...
    init: function ( parent ) {
        $( function () {
            linear_progress.data.linear_progress_ids = [];
            if ( parent ) {
                $( parent ).find( '[id^=\'linear_progress\']' ).each( function ( i, item ) {
                    linear_progress.data.linear_progress_ids.push( item.id );
                } );
            }
            else {
            ...
            linear_progress.data.append();
        } );
    }
};

linear_progress.init( 'body' );
